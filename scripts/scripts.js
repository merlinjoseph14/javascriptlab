...
function recalculate() {
    let newTotalCost = document.getElementById("calculated-cost");
    if (modelName === 'Model XYZ') {
        newTotalCost.innerHTML = (duration * 100).toFixed(2); 
    } else if (modelName === 'Model CPRG') {
        newTotalCost.innerHTML = (duration * 213).toFixed(2); 
    }
}
...
function changeDuration() {
    ...
    let inputDuration = prompt('Enter duration: ');
    let newDuration = parseFloat(inputDuration);
